-- Update default value for the column email_device_activity to FALSE (In-App Only)
ALTER TABLE public.notification_preferences
  ALTER COLUMN email_device_activity SET DEFAULT FALSE;

-- Update the handle_new_user_profile trigger function to insert FALSE
...
BEGIN
  ...
  INSERT INTO public.notification_preferences (
    ...
    NEW.id,
    TRUE,  TRUE,
    FALSE, FALSE, -- Changed email_device_activity to FALSE
    FALSE, FALSE, FALSE,
    TRUE,  TRUE,
    TRUE,  TRUE,
    TRUE,  TRUE, TRUE,
