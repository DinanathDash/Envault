...
<Callout type="info">
  We are accepting 5-10 free design partners to stress-test these paths. Try to break CLI flows, GitHub JIT onboarding, and HITL fencing, then send us repro steps.
</Callout>
