...
description: Manual MCP configuration and runtime controls for advanced Envault agent workflows.
---
...
<Callout type="info">
  All agent requests, approvals, and rejections are recorded in your Project
  Audit Logs for traceability and debugging.
</Callout>
